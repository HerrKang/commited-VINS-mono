...
bool ProjectionFactor::Evaluate(double const *const *parameters, double *residuals, double **jacobians) const
{
    ...
    Eigen::Vector3d pts_camera_i = pts_i / inv_dep_i;//第i帧相机坐标系
    Eigen::Vector3d pts_imu_i = qic * pts_camera_i + tic;//第i帧惯导坐标系
    Eigen::Vector3d pts_w = Qi * pts_imu_i + Pi;//世界坐标系
    Eigen::Vector3d pts_imu_j = Qj.inverse() * (pts_w - Pj);//第j帧惯导坐标系
    ...
    residual = (pts_camera_j / dep_j).head<2>() - pts_j.head<2>();//prediction-meansurement
#endif
